...
export default async function AdminEventDetailPage({ params }: any) {
        ...
        <section className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2 text-neutral-800">
              <p><strong>Date:</strong> {new Date(event.date).toLocaleString("en-GB")}</p>
              <p><strong>Store:</strong> {event.stores?.name}</p>
              <p className="text-sm text-neutral-600">{event.stores?.address}</p>
          ...
          <div className="flex flex-wrap gap-10 pt-4">
            ...
            <div>
              ...
              <p><strong>Total seats:</strong> {event.capacity}</p>
              <p><strong>Booked:</strong> {seatsTaken}</p>
              <p><strong>Remaining:</strong> {seatsLeft}</p>
            </div>

            <div>
              <h3 className="text-xl font-semibold mb-2">Revenue</h3>
              <p><strong>Ticket price:</strong> £{(event.price_pence / 100).toFixed(2)}</p>
